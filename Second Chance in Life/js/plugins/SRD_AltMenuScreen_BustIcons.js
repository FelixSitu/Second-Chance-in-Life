...
(function() {
	...
	Window_MenuCommand.prototype.windowWidth = function() {
		...
		//return ((2 * (this.itemWidth() + (this.textPadding() * 2))) + 
	    	//(this.standardPadding() * 2)) - (this.textPadding() * 2);
	};
	...
	Window_MenuStatus.prototype.drawItemStatus = function(index) {
	    ...
	    //this.contents.fillRect(x, y, this.itemWidth(), boxHeight/3 - 50, sBack);
	    this.drawActorName(actor, x+45, y);
	    this.drawActorLevel(actor, x+25, y + lineHeight * 1);
	...
	Window_MenuStatus.prototype.drawBust = function(actor, rect, xOff, yOff) {
	    ...
	    this.contents.blt(bitmap, 0, 0, this.itemWidth()+40, bitmap.height, rect.x + xOff, (rect.height - bitmap.height) + yOff);
	};
